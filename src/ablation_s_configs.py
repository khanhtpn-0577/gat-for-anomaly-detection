# -*- coding: utf-8 -*-
"""
Ablation study: effect of different fixed S configurations.
...
class ContrastiveGAT(nn.Module):
    def __init__(self, in_ch, hid, out_ch):
        super().__init__()
        self.gat1 = GATConv(in_ch,   hid,    heads=4, concat=True,  dropout=0.2, edge_dim=1)
        self.gat2 = GATConv(hid*4,   hid,    heads=4, concat=True,  dropout=0.2, edge_dim=1)
        self.gat3 = GATConv(hid*4,   out_ch, heads=1, concat=False, dropout=0.1, edge_dim=1)
